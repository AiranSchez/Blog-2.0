...
* Later, at a Technology Institute, I collaborated in creating a web platform that allowed users to access a virtual machine with pre-installed mathematical libraries directly from the browser. This included report generation and cloud storage, using technologies like Next.js, MongoDB, AWS, and deployment tools such as ArgoCD and Jenkins.
